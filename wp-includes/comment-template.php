...
?>
		...
		<?php printf(__('<cite class="fn">%s</cite> <span class="comment-stars">('. arg_create_level_stars(get_comment(get_comment_ID())->user_id). ')</span> <span class="says">says:</span>'), get_comment_author_link()) ?>
		</div>
