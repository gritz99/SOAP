	...
	function widget( $args, $instance ) {
		...
		<?php if ( bp_has_members( 'user_id=0&type=' . $instance['member_default'] . '&max=' . $instance['max_members'] . '&populate_extras=0' ) ) : ?>
			<style type="text/css">
				...
				.widget_bp_core_members_widget .vcard .item-avatar { float: left; }
				.widget_bp_core_members_widget .vcard .item-avatar a { float:none; }
				.widget_bp_core_members_widget .vcard .item { line-height:120%;}
				.widget_bp_core_members_widget .vcard .item .item-title a { float:none; }
				.widget_bp_core_members_widget .vcard .item .arg_user_stats_star { width:12px; height:12px; display:inline-block; background-image:url('<?php bloginfo('template_directory'); ?>/images/stars12.png'); }
				.widget_bp_core_members_widget .vcard .item .arg_user_stats_star.star_on { background-position:0px -24px; }
				.widget_bp_core_members_widget .vcard .item .item-meta { float:none; width:80%; }
				.widget_bp_core_members_widget .vcard .item .item-meta span { float:none; display:block; padding-left:40px;  }
			</style>
				...
				<?php while ( bp_members() ) : bp_the_member(); ?>
					<li class="vcard">
						...
						<div class="item">
							...
							<div class="item-stars"><?php echo arg_create_level_stars(bp_get_member_user_id()); ?></div>
							<div class="item-meta">
								<span class="activity">
								<?php
